...
# this program initial width and height
app_width = 1300
app_height = 900

# # background colour in the form x colours (example: gray90) or #xxxxxx or #xx
# USE_ALPHA = 1
# PAGE_BG = "gray90"
...
class Application(ttk.Frame):
    ...
    def create_widgets(self):
        ...
        self.s.configure('new.TFrame', background=PAGE_BG)
        ...
        self.canvas = tk.Canvas(self.cframe, width=0, height=0, scrollregion=(0,0,app_width,app_height), bg=PAGE_BG)
        ## scrollbars
    ...
    def fcanvas(self, rot=0):
        ...
        # the page to image 
        self.pix = self.page.getPixmap(matrix=self.mat, colorspace=fitz.csRGB, alpha=USE_ALPHA)
